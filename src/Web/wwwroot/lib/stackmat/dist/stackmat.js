(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Stackmat = factory());
    ...
    const stackmatWorkletProcessor = URL.createObjectURL(new Blob(['(', function () {
    ...
    const isEvent = (x) => typeof x === 'string' && types.includes(x);
